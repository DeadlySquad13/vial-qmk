...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_BASE] = LAYOUT( \
          ...
          MEDIA,  KC_Z, KC_X,      KC_C,      KC_V,      KC_B,                             KC_N,      KC_M,      KC_COMM,   KC_DOT,    KC_SLSH, CAPS_WORD_SETS, \
        ...
        [_GAME] = LAYOUT( \
            ...
            KC_ESC,  _______, KC_W,    _______, _______, _______,                           _______, _______,  _______, _______, _______, GAME_SHOOTER,
        ...
        [_GAME_SHOOTER] = LAYOUT( \
            _______, _______, _______, _______, _______, _______,                           _______, _______,  _______, _______, _______, GAME_RIGHT,
            KC_ESC,  _______, KC_W,    _______, _______, _______,                           _______, _______,  _______, _______, _______, GAME,
            KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    _______,                           _______, _______,  _______, _______, _______, _______,
            KC_LSFT, _______, _______, _______, _______, _______,                           _______, _______,  _______, _______, _______, KC_INS,
                              BASE,    _______, KC_LCTL, KC_SPACE, KC_LALT,        _______, _______, KC_ENTER, KC_BSPC, BASE \
        ),
        ...
        [_CAPS_WORD_SETS] = LAYOUT( \
            _______, _______, _______,               _______,              _______,              _______,                          _______, _______,              _______,              _______,               _______,  _______,
            _______, _______, _______,               _______,              CAPS_WORD_SLASH_CASE, _______,                          _______, CAPS_WORD_SLASH_CASE, _______,              _______,               _______,  _______,
            _______, _______, CAPS_WORD_PASCAL_CASE, CAPS_WORD_DASH_CASE,  CAPS_WORD,            _______,                          _______, CAPS_WORD,            CAPS_WORD_DASH_CASE,  CAPS_WORD_PASCAL_CASE, _______,  _______,
            _______, _______, CAPS_WORD_TITLE_CASE,  CAPS_WORD_SNAKE_CASE, CAPS_WORD_CAMEL_CASE, _______,                          _______, CAPS_WORD_CAMEL_CASE, CAPS_WORD_SNAKE_CASE, CAPS_WORD_TITLE_CASE,  _______,  _______,
                              _______,               _______,              _______,              _______, _______,        _______, _______, _______,              _______,              _______ \
        ),
};
